...
names = ['An', 'Bình', 'Chi', 'Dũng', 'Hà', 'Hương', 'Khoa', 'Lan', 
         'Minh', 'Ngọc', 'Phúc', 'Quân', 'Thảo', 'Trang', 'Vinh', 'Yến', 'Tuấn', 'Hải', 'Linh', 'Mai', 'Nam', 'Oanh', 'Phương', 'Quỳnh', 'Sơn', 'Tú', 'Vy']
classrooms = ['10A1', '10A2', '11B1', '11B2', '12C1', '12C2', '12C3', '12C4', '12C5']
genders = ['Nam', 'Nữ']
statuses = ['Đang học', 'Nghỉ học']
academics = ['Giỏi', 'Khá', 'Trung bình', 'Yếu']
