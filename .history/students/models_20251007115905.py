...
#verbose_name	Tên hiển thị dễ hiểu	verbose_name='Họ tên'
    ...
    is_deleted = models.BooleanField(default=False)  # Trường để đánh dấu học sinh đã bị xoáapplication_status = models.CharField(max_length=10, choices=APPLICATION_CHOICES, default='pending')
