...
def dashboard(request):
    ...
    # Sử dụng values('academic_status') để nhóm các học sinh theo trạng thái học tập
    # Sử dụng annotate(count=Count('id')) để đếm số lượng học sinh trong mỗi nhóm
    # Kết quả trả về sẽ có dạng: [{'academic_status': 'Excellent', 'count': 10}, {'academic_status': 'Good', 'count': 15}, ...]
