...
def student_detail(request, student_id):
    class_stats_raw = Student.objects.filter(is_deleted=False).values('class_name').annotate(
    count=Count('id'),
    avg_score=Avg('score')
)
...
class_stats = [
    ...
    return render(request, 'students/student_detail.html', {'student': student, 'class_stats': class_stats})
