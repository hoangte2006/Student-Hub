...
class StudentForm(forms.ModelForm):
    class Meta:
        model = Student
        fields = ['name', 'age', 'classroom', 'gender', 'study_sstatus', 'academic', 'score', 'email', 'birthday']
        widgets = {
...
def student_list(request):  
    ...
    study_status = request.GET.get('status', '').strip()
    ...
    if filters['study_status']:
        students = students.filter(study_status=filters['stustatus'])
