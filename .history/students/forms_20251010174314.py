...
class StudentForm(forms.ModelForm): # Tạo một biểu mẫu dựa trên mô hình Student
    class Meta: 
        ...
        fields = ['name', 'age', 'classroom', 'gender', 'address', '', 'study_status', 'academic', 'score', 'email', 'birthday', 'address', 'phone', 'application_status', 'application_date', 'payment_status', 'payment_date']
        widgets = {
