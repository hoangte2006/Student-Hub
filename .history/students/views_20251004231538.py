...
def trash_list(request):
    deleted_students = Student.objects.filter(is_deleted=True)  # Lấy tất cả học sinh đã bị xoá (is_deleted=True)
    return render(request, 'students/trash_list.html', {'deleted_students': deleted_students})
