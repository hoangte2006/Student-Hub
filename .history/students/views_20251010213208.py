...
from .forms import StudentFormClean as StudentForm
...
def student_list(request):  
    ...
    if amount_paid:
        try:
            ...
            pass  # Bỏ qua nếu không thể chuyển đổi sang float
    if application_note:
...
→ Truy cập lại /add/ → nếu form đầy đủ → lỗi nằm ở class StudentForm cũ bị cache hoặc override    return render(request, 'students/add_student.html', {'form': form}) # Truyền biểu mẫu vào ngữ cảnh để hiển thị trong template
