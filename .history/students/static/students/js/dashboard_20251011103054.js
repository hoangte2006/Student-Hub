...
// ngoài DOMContentLoaded (trên cùng file)
let chart = null;
chart.data.datasets[0].data = [61,39,55,123];
chart.update();
console.log('🔧 forced update with hard numbers');

// trong DOMContentLoaded khi tạo chart:
